...
#if TARGET_OS_VISION
    self.window = [[UIWindow alloc] initWithFrame:CGRectMake(0, 0, 1920, 1080)];
#else
...
#if TARGET_OS_VISION
    containerView.layer.rasterizationScale = 2.0;
#else
...
- (void)cleanup{
    ...
    {
#if !TARGET_OS_VISION
        // Use helper method to get current active window
...
- (void)loadView{
#if TARGET_OS_VISION
    self.view = [[UIView alloc] initWithFrame:CGRectMake(0, 0, 1920, 1080)];
#else

...
//  ZoomVideoSample
//
//  Created by Zoom Communications on 2019/5/30.
...
//    UIInterfaceOrientation orientation = [UISceneOrientationHelper currentInterfaceOrientation];
...
- (void)setCellValue:(ZoomVideoSDKChatMessage *)msg
{
    ZoomVideoSDKUser *sender = msg.senderUser;
